...
VERDICT_PROMPT = """You are a fact-checking assistant. Given the following claim and evidence, produce \
a structured verdict. Respond in {language}.
...
- Weight the classifier signal alongside the evidence when forming your verdict."""
